...
|------|------------|-------------|-------------------------------|
| 2026-09-14 | Lager **ikke** `proposal.md` | Ingen av de 132 repoene i kullet har en slik fil, heller ikke de to «Example»-repoene. Forslaget ble levert utenfor repoet (trolig Canvas), og briefen har uansett erstattet det. Å lage en nå ville vært å tilbakedatere et allerede erstattet dokument | Skrive en `proposal.md` i etterkant for å fylle uke 42-raden i tidsplanen |
